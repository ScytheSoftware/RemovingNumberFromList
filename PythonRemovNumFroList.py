...
#DaVonte' Whitfield 4/5/2019 Python 'User entering number 
#to remove numbers from a predetermined list.'
...
def show_list(list):
	print("\nThis is the list currently {}.".format(list))
	...
	while True:
		try:
			...
			if index == 0:
				...
				clear_screen() #To wipe the screen each loop.
				print("The value {} has been removed fully.\n".format(value))
				break
		index +=1


clear_screen()  #To wipe the screen to only show results.
